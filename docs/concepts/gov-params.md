...
| key                 | Description                                      | Range                                                    | Current                                                                                                        |
| ------------------- | ------------------------------------------------ | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `gov/depositparams` | Related parameters of the deposit mortgage phase | max_deposit_period:(0, 9223372036854775807]              | {"min_deposit": [{"denom": "utfury", "amount": "1000000000"}], "max_deposit_period": "86400s" }                 |
...
| `mint/MintDenom` | Denom of the token mintable |          | utfury   |
...
| `service/MinDeposit`           | Minimum deposit amount                                      | amount: (0, +∞)           | [{"denom": "utfury","amount": "5000000000"}] |
| `service/BaseDenom`            | Token denom that must be used for deposits                  |                           | utfury                                       |
...
| `staking/BondDenom`         | Bond denom                                                      |                          | utfury    |
