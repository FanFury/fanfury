...
The value of `inflationBasement` is specified in genesis file. By default its value `2000000000fury`(2 billion fury, `1 fury` equals `1*10^18 utfury`), and its value will never be changed.
Suppose `blockCostTime` is 5000 millisecond, and `inflationRate` is `4%`, then the inflation amount will be `12675235125611580094utfury` (`12.675235125611580094fury`)
