        ...
        "msg": [
            {
                ...
                "value": {
                    "from_address": "did:fury:iaa1rkgdpj6fyyyu7pnhmc3v7gw9uls4mnajvzdwkt",
                    "to_address": "did:fury:iaa1q6t5439f0rkvkzl38m0f43e0kpv3mx7x2shlq8",
                    "amount": [
                        {
                            "denom": "utfury",
                            "amount": "1000000"
...
Denom uses `utfury` instead (1fury = 10<sup>6</sup>utfury), which affects fields:
...
```bash
curl -X POST "http://localhost:1317/txs" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"tx\": {\"msg\":[{\"type\":\"cosmos-sdk/MsgSend\",\"value\":{\"from_address\":\"did:fury:iaa1rkgdpj6fyyyu7pnhmc3v7gw9uls4mnajvzdwkt\",\"to_address\":\"did:fury:iaa1q6t5439f0rkvkzl38m0f43e0kpv3mx7x2shlq8\",\"amount\":[{\"denom\":\"utfury\",\"amount\":\"1000000\"}]}}],\"fee\":{\"amount\":[{\"denom\":\"utfury\",\"amount\":\"30000\"}],\"gas\":\"200000\"},\"signatures\":[{\"pub_key\":{\"type\":\"tendermint/PubKeySecp256k1\",\"value\":\"AxGagdsRTKni/h1+vCFzTpNltwoiU7SwIR2dg6Jl5a//\"},\"signature\":\"Pu8yiRVO8oB2YDDHyB047dXNArbVImasmKBrm8Kr+6B08y8QQ7YG1eVgHi5OIYYclccCf3Ju/BQ78qsMWMniNQ==\"}],\"memo\":\"Sent via furyhub client\"}, \"mode\": \"block\"}"
```
...
- **Sample JSON:**
  ...
  ```json
  {
      ...
      "raw_log": "[{\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\"},{\"key\":\"sender\",\"value\":\"did:fury:iaa18awn3k70u05tlcul8w2qnl64g002uj4kjn93rn\"},{\"key\":\"module\",\"value\":\"bank\"}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"did:fury:iaa1w976a5jrhsj06dqmrh2x9qxzel74qtcmapklxc\"},{\"key\":\"sender\",\"value\":\"did:fury:iaa18awn3k70u05tlcul8w2qnl64g002uj4kjn93rn\"},{\"key\":\"amount\",\"value\":\"1000000utfury\"}]}]}]",
      "logs": [
          {
              "events": [
                  {
                      ...
                      "attributes": [
                          ...
                          {
                              "key": "sender",
                              "value": "did:fury:iaa18awn3k70u05tlcul8w2qnl64g002uj4kjn93rn"
                          },
                          {
                              "key": "module",
                              "value": "bank"
                  ...
                  },
                  {
                      ...
                      "attributes": [
                          {
                              "key": "recipient",
                              "value": "did:fury:iaa1w976a5jrhsj06dqmrh2x9qxzel74qtcmapklxc"
                          },
                          {
                              "key": "sender",
                              "value": "did:fury:iaa18awn3k70u05tlcul8w2qnl64g002uj4kjn93rn"
              ...
              "msg": [
                  {
                      "type": "cosmos-sdk/MsgSend",
                      "value": {
                          "from_address": "did:fury:iaa18awn3k70u05tlcul8w2qnl64g002uj4kjn93rn",
                          "to_address": "did:fury:iaa1w976a5jrhsj06dqmrh2x9qxzel74qtcmapklxc",
                          "amount": [
                              {
                                  "denom": "utfury",
                                  "amount": "1000000"
